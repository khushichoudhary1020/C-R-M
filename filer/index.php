...
{
$ret=mysqli_query($con,"SELECT * FROM filer WHERE name='".$_POST['username']."' and password='".$_POST['password']."'");
...
<div class="container">
  <div class="login-container">  
        <div class="col-md-5">
          <h2 class="text-center text-white"><strong>TVE - Filer Login</strong></h2>
          <hr>
        </div>
        <div class="col-md-5 "> 
