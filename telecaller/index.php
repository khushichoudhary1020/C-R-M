...
{
$ret=mysqli_query($con,"SELECT * FROM telecaller WHERE name='".$_POST['username']."' and password='".$_POST['password']."'");
...
<meta charset="utf-8" />
<title>CRM | Telecaller Login</title>
...
<div class="container">
  <div class="login-container">  
        <div class="col-md-5">
          <h2 class="text-center text-white"><strong>TVE - Telecaller Login</strong></h2>
          <hr>
        </div>
        <div class="col-md-5 "> 
         ...
         <div class="mb-3">
                           <div class="mb-3">
                              <div class="form-check">
                                 ...
                                 <label class="form-check-label" for="exampleCheck1"><small>I Acknowledge Terms
                                          Of Service And Privacy Policy*</small></label>
                              </div>
                           </div>
                        </div>
