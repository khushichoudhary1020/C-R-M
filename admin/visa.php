	  ...
	  <div class="row">	 
		<div class="col-md-3 col-vlg-3 col-sm-6">
			<div class="tiles green m-b-10">
			  ...
			  <div class="controller"> <a href="javascript:;" class="reload"></a> <a href="javascript:;" class="remove"></a> </div>
                ...
                <a href="get-quote.php" style="color:#FFF">Visitors Visa </a> 
		...
		<div class="col-md-3 col-vlg-3 col-sm-6">
			<div class="tiles blue m-b-10">
			  ...
			  <div class="controller"> <a href="javascript:;" class="reload"></a> <a href="javascript:;" class="remove"></a> </div>
                <div class="tiles-title ">
                <a href="get-quote.php" style="color:#FFF">Student Visa </a> 
		...
		<div class="col-md-3 col-vlg-3 col-sm-6">
			<div class="tiles purple m-b-10">
			  ...
			  <div class="controller"> <a href="javascript:;" class="reload"></a> <a href="javascript:;" class="remove"></a> </div>
                <div class="tiles-title ">
                <a href="get-quote.php" style="color:#FFF">Family Visa </a> 
                </div>
			         <div class="widget-stats">
                      <div class="wrapper transparent"> 
                      <?php
		...
		<div class="col-md-3 col-vlg-3 col-sm-6">
			<div class="tiles red m-b-10">
			  ...
			  <div class="controller"> <a href="javascript:;" class="reload"></a> <a href="javascript:;" class="remove"></a> </div>
                <div class="tiles-title ">
                <a href="get-quote.php" style="color:#FFF">PR Visa  </a>
                </div>
			         <div class="widget-stats">
                      <div class="wrapper transparent"> 
      ...
      <div class="row">	 
		<div class="col-md-3 col-vlg-3 col-sm-6">
			<div class="tiles green m-b-10">
			  ...
			  <div class="controller"> <a href="javascript:;" class="reload"></a> <a href="javascript:;" class="remove"></a> </div>
                <div class="tiles-title ">
                <a href="get-quote.php" style="color:#FFF">Tourist Visa </a>
                </div>
			         <div class="widget-stats">
                      <div class="wrapper transparent"> 
                      <?php $ov=mysqli_query($con,"select * from usercheck");
