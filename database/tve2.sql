...
INSERT INTO `telecaller` (`id`, `name`, `password`) VALUES
(1, 'admin', 'telecaller123');
...
CREATE TABLE `ticket` (
  `id` int(11) NOT NULL,
  `lead_id` varchar(11) DEFAULT NULL,
  `email_id` varchar(300) DEFAULT NULL,
  `name` varchar(300) DEFAULT NULL,
  `mobile` varchar(300) DEFAULT NULL,
  `tenth` varchar(300) DEFAULT NULL,
  `twelfth` longtext DEFAULT NULL,
  `visa_type` longtext DEFAULT NULL,
  `course_type` longtext DEFAULT NULL,
  `feedback1` longtext DEFAULT NULL,
  `call1` longtext DEFAULT NULL,
  `assign1` longtext DEFAULT NULL,
  `attachment` longtext DEFAULT NULL,
  `status` longtext DEFAULT NULL,
  `admin_remark` longtext DEFAULT NULL,
  `generation_date` longtext DEFAULT NULL,
  `admin_remark_date` longtext DEFAULT NULL,
...
INSERT INTO `ticket` (`id`, `lead_id`, `email_id`, `name`, `mobile`, `tenth`, `twelfth`, `visa_type`, `course_type`, `feedback1`, `call1`, `assign1`, `attachment`, `status`, `admin_remark`, `generation_date`, `admin_remark_date`) VALUES
(13, '6', 'khushi@mail.com', 'khushi', '9876543210', '98', '87', 'Study Visa', 'course 1', 'went well','done', 'Counsellor', NULL, '', '2022-11-29', '2022-11-29 05:53:10'),
(13, '6', 'khushi@mail.com', 'khushi', '9876543210', '98', '87', 'Study Visa', 'course 1', 'went well','done', 'Counsellor', NULL, '', '2022-11-29', '2022-11-29 05:53:10');
