...
$id=$_GET['id'];
	$ret=mysqli_query($con,"update leads set assign1='$assign1' where id='$id'");
	if($ret)
	{
                      ...
                      <div class="row justify-content-center">
                        <div class="col-lg-8 col-md-10 col-xs-12 mx-auto">
                            <div class="form-group">
                              <label for="assign1" class="control-label">Assign</label>
                              <input type="text" class="form-control rounded-0" id="assign1" name="assign1" value="<?php echo $rw['assign1'];?>" required="required">
                            </div>
                            <div class="form-group">
