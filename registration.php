...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
  ...
  echo "<script>window.location.href='registration.php'</script>";
	...
	{
 mysqli_query($con,"insert into user(name,email,password,mobile,service) values('$name','$email','$password','$mobile','$service')");
        ...
        <div class="col-md-5 "> <br>
		 ...
		 <div class="form-group col-md-10">
          ...
          <div class="form-group col-md-10">
            ...
            <div class="controls">
				<div class="input-with-icon  right">                                       
					<input type="radio" value="m" name="service" checked > Filer
          <input type="radio" value="f" name="service" > Tele-Caller
          <input type="radio" value="f" name="service" > Counsellor
         ...
         <div class="row">
            <div class="col-md-10">
              <input   class="btn btn-primary btn-cons pull-right" name="submit" value="Register" type="submit" />
            </div>
          </div>
		  </form>
        </div>
