...
if(isset($_POST['change']))
{
  ...
  $telecallerid=$_SESSION['id'];
  $newpassword=$_POST['newpass'];
 $sql=mysqli_query($con,"SELECT `password` FROM  `telecaller` where `password`='$oldpas' and id='$telecallerid'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"UPDATE  telecaller set password='$newpassword' where id='$telecallerid'");
...
<meta charset="utf-8" />
<title>TVE | Change Password</title>
