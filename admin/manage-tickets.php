...
$fid=$_POST['frm_id'] ;
mysqli_query($con,"update leads set admin_remark='$adminremark',status='closed' where id='$fid'");
...
<div class="page-container row"> 
  ...
  <div class="page-content">
    ...
    <div class="content">
      ...
      <div class="clearfix"></div>
     <?php $rt=mysqli_query($con,"select * from leads order by id desc");
        ...
        <div class="col-md-12">
          <div class="grid simple no-border">
            <div class="grid-title no-border descriptive clickable">
              ...
              <p ><span class="text-success bold">Lead #<?php echo $_SESSION['sid']=$row['lead_id'];?></span> - Created on <?php echo $row['generation_date'];?>
            ...
            <div class="grid-body  no-border" style="display:none">
              <div class="post">
                ...
                <div class="info-wrapper">
                  <div class="info"><?php echo $row['leads'];?> </div>
                  <div class="clearfix"></div>
                </div>
                <div class="clearfix"></div>
              </div>
