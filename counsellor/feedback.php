...
$id=$_GET['id'];
	$ret=mysqli_query($con,"update leads set feedback2='$feedback2' where id='$id'");
	if($ret)
	{
                      ...
                      <div class="row justify-content-center">
                        <div class="col-lg-8 col-md-10 col-xs-12 mx-auto">
                            <div class="form-group">
                              <label for="feedback2" class="control-label">Please add a Feedback</label>
                              <input type="text" class="form-control rounded-0" id="feedback2" name="feedback2" value="<?php echo $rw['feedback2'];?>" required="required">
                            </div>
                            <div class="form-group">
