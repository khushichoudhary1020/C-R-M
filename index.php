...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
          <a class="nav-link" href="telecaller/">Telecaller</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="counsellor/">Counsellor</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="filer/">Filer</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="admin/">Others</a>
          </li>
  ...
  <header class="masthead text-right text-white">
    <div class="masthead-content">
      ...
      <div>
      <h6 class="masthead-subheading mb-0"></h>
      </div>
    </div>
  </header>
